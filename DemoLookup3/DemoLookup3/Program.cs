...
namespace DemoLookup3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //使用姓作為Lookup的鍵值Value值為Name內容
            ILookup<string, string> lookup = gList.ToLookup(guest => guest.Name.Substring(0, 1),g=>g.Name);
            ...
            foreach (var k in lookup)
            {
                ...
                foreach (var v in k)
                    Console.WriteLine(string.Format("姓名：{0}", v));
