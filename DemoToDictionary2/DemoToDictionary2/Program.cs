...
namespace DemoToDictionary2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //使用Name內容作為Dictionary的鍵值
            Dictionary<string, GuestInfo> dictionary = gList.ToDictionary(guest => guest.Name,new MyEqualityComparer<string>());
            ...
            Console.WriteLine("\n檢查dictionary全部的元素");
            foreach (var s in dictionary)
                Console.WriteLine(string.Format("鍵值：{0}，電話：{1}", s.Key, s.Value.Tel));
