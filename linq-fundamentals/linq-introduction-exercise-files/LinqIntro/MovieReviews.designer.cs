...
namespace LinqIntro
{
    ...
    partial void OnReleaseDateChanged();
		...
		[Column(Name="movie_id", Storage="_MovieID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MovieID
		{
			get
			{
    ...
    partial void OnReviewerChanged();
		...
		[Column(Name="review_id", Storage="_ReviewID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ReviewID
		{
			get
			{
